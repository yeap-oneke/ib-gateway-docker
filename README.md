...
[![Build](https://github.com/yeap-oneke/ib-gateway-docker/actions/workflows/on-push-n-pr.yml/badge.svg?branch=master)](https://github.com/yeap-oneke/ib-gateway-docker/actions) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) [![GitHub Discussions](https://img.shields.io/github/discussions/yeap-oneke/ib-gateway-docker)](https://github.com/yeap-oneke/ib-gateway-docker/discussions) [![GitHub Repo stars](https://img.shields.io/github/stars/yeap-oneke/ib-gateway-docker)](#repo-stats) [![GitHub forks](https://img.shields.io/github/forks/yeap-oneke/ib-gateway-docker)](https://github.com/yeap-oneke/ib-gateway-docker/network/members)

<img src="https://github.com/yeap-oneke/ib-gateway-docker/blob/master/logo.png" height="300" class="center" alt="IB Gateway Docker"/>
...
| --- | -------- | ------------------- | ---------------- | ---------------------------------------------- |
| [ib-gateway][1] | `latest` | `10.48.1d` | `3.24.1` | `latest` `10.48` `10.48.1d` |
| [ib-gateway][1] |`stable` | `10.45.1h` | `3.24.1` | `stable` `10.45` `10.45.1h` |
| [tws-rdesktop][2] | `latest` | `10.48.1d` | `3.24.1` | `latest` `10.48` `10.48.1d` |
...
[ib-gateway-compose](https://github.com/yeap-oneke/ib-gateway-docker/blob/master/docker-compose.yml) and
[tws-rdesktop-compose](https://github.com/yeap-oneke/ib-gateway-docker/blob/master/tws-docker-compose.yml).
...
Create an .env on root directory. You can use the provided [.env-dist](https://github.com/yeap-oneke/ib-gateway-docker/blob/master/.env-dist) as a starting point. Example .env file:
...
[discussion](https://github.com/yeap-oneke/ib-gateway-docker/discussions) section for common
problems and solutions. If you have problems please go through the [troubleshooting guide](https://github.com/yeap-oneke/ib-gateway-docker/discussions/245)
...
| `EXISTING_SESSION_DETECTED_ACTION` | Set Existing Session Detected Action. See IBC [documentation](https://github.com/yeap-oneke/ib-gateway-docker/blob/master/latest/config/ibc/config.ini.tmpl#L296-L329) | primary |
...
From `10.26.1h` it's possible to run TWS in a container. [tws-rdesktop](https://github.com/yeap-oneke/ib-gateway-docker/pkgs/container/tws-rdesktop) image provides a desktop environment that allows to use TWS.

### Performance considerations for TWS

[tws-rdesktop](https://github.com/yeap-oneke/ib-gateway-docker/pkgs/container/tws-rdesktop) has the following recomended settings.

In [tws-docker-compose.yml](https://github.com/yeap-oneke/ib-gateway-docker/blob/master/tws-docker-compose.yml):
...
| --- | --- | --- |
| IB Gateway | /home/ibgateway/Jts/jts.ini    | [jts.ini](https://github.com/yeap-oneke/ib-gateway-docker/blob/master/image-files/config/ibgateway/jts.ini.tmpl) |
| IBC  | /home/ibgateway/ibc/config.ini | [config.ini](https://github.com/yeap-oneke/ib-gateway-docker/blob/master/image-files/config/ibc/config.ini.tmpl) |

For TWS image config file locations are:

| App | Config file  | Default  |
| --- | --- | --- |
| TWS | /opt/ibkr/jts.ini   | [jts.ini](https://github.com/yeap-oneke/ib-gateway-docker/blob/master/image-files/config/ibgateway/jts.ini.tmpl) |
| IBC | /opt/ibc/config.ini | [config.ini](https://github.com/yeap-oneke/ib-gateway-docker/blob/master/image-files/config/ibc/config.ini.tmpl) |
...
- Available to `localhost`, this is the default setup provided in [docker-compose.yml](https://github.com/yeap-oneke/ib-gateway-docker/blob/master/docker-compose.yml).
...
[ib-gateway-docker](https://github.com/yeap-oneke/ib-gateway-docker) with a
sidecar [ssh bastion](https://github.com/yeap-oneke/docker-bastion) and a
[jupyter-quant](https://github.com/yeap-oneke/jupyter-quant), which provides a
...
[jupyter-quant](https://github.com/yeap-oneke/jupyter-quant) will open a **local**
...
[jupyter-quant](https://github.com/yeap-oneke/jupyter-quant) making it available
for use with [ib_insync](https://github.com/erdewit/ib_insync). The only port
available to the outside world is the
[ssh bastion](https://github.com/yeap-oneke/docker-bastion) port, which has hardened
...
In "discussion" section you will find full examples for [ib-gateway](https://github.com/yeap-oneke/ib-gateway-docker/discussions/103) and [tws-rdesktop](https://github.com/yeap-oneke/ib-gateway-docker/discussions/105)
...
[instructions](https://github.com/yeap-oneke/ib-gateway-docker/discussions/104).
...
Note that the
[Dockerfile](https://github.com/yeap-oneke/ib-gateway-docker/blob/master/Dockerfile)
**does not download IB Gateway installer files from IB homepage but from the
[github-releases](https://github.com/yeap-oneke/ib-gateway-docker/releases) of this
project**.
...
[releases](https://github.com/yeap-oneke/ib-gateway-docker/releases) have been
...
on [Dockerfile](https://github.com/yeap-oneke/ib-gateway-docker/blob/master/Dockerfile)
`RUN curl -sSL
https://github.com/yeap-oneke/ib-gateway-docker/raw/gh-pages/ibgateway-releases/ibgateway-${IB_GATEWAY_VERSION}-standalone-linux-x64.sh
...
1. Clone this repo
    ...
    ```bash
      git clone https://github.com/yeap-oneke/ib-gateway-docker
    ```
...
1. Change docker file to use your local IB Gateway installer file, instead of
   ...
   ```docker
   RUN curl -sSL https://github.com/yeap-oneke/ib-gateway-docker/raw/gh-pages/ibgateway-releases/ibgateway-${IB_GATEWAY_VERSION}-standalone-linux-x64.sh \
       --output ibgateway-${IB_GATEWAY_VERSION}-standalone-linux-x64.sh
   RUN curl -sSL https://github.com/yeap-oneke/ib-gateway-docker/raw/gh-pages/ibgateway-releases/ibgateway-${IB_GATEWAY_VERSION}-standalone-linux-x64.sh.sha256 \
...
[1]: https://github.com/users/yeap-oneke/packages/container/package/ib-gateway "ib-gateway"
[2]: https://github.com/yeap-oneke/ib-gateway-docker/pkgs/container/tws-rdesktop "tws-rdesktop"

## Repo stats

Repository stars overtime.

[![Stargazers over time](https://starchart.cc/yeap-oneke/ib-gateway-docker.svg?variant=adaptive)](https://starchart.cc/yeap-oneke/ib-gateway-docker)
